...
I always wanted to have my own personal blog and finally I had some time
to build it. This is my first post and explains how I created this blog.🚀💪

# Requirements

I've never had a blog before and therefore I wasn't sure what I need and
what most of the existing platforms offer. Usually I start new projects by
thinking about the requirements, which gives me a nice overview of the project's
...
- I wanted to build it by myself. 🧑‍💻
  ...
  - (At first I was thinking of some HTML and CSS files, which are stored in a github
    ...
    directly from the [git-styleguide Github repository].)
...
Please check out my next blog post , where I'll provide an
...
- Finally, I had to link the domain name to the IP-address of the Netlify webserver.
